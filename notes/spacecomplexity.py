...
#
# Space complexity *includes* the original data (how much including original data)
# Auxiliary Space Complexity does not include the original data (how much additional)
​
def foo(a):
